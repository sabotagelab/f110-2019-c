...
if("FALSE" STREQUAL "TRUE")
  set(ackermann_cmd_mux_SOURCE_PREFIX /home/michaela/f110-2019-c/week2-lidar-ws/src/f110-skeletons-spring2019/system/racecar/ackermann_cmd_mux)
  set(ackermann_cmd_mux_DEVEL_PREFIX /home/michaela/f110-2019-c/week2-lidar-ws/devel)
  ...
  set(ackermann_cmd_mux_INSTALL_PREFIX /home/michaela/f110-2019-c/week2-lidar-ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ackermann_cmd_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/michaela/f110-2019-c/week2-lidar-ws/install/${idir}'.  ${_report}")
    endif()
