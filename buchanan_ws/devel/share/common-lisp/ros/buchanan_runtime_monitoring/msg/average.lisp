...
(cl:in-package buchanan_runtime_monitoring-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <average>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'average)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name buchanan_runtime_monitoring-msg:<average> is deprecated: use buchanan_runtime_monitoring-msg:average instead.")))

(cl:ensure-generic-function 'average-val :lambda-list '(m))
(cl:defmethod average-val ((m <average>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader buchanan_runtime_monitoring-msg:average-val is deprecated.  Use buchanan_runtime_monitoring-msg:average instead.")
  (average m))
