...
if("TRUE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/michaela/f110-2019-c/week4-wall-ws/src/f110-skeletons-spring2019/system/vesc/vesc_msgs)
  set(vesc_msgs_DEVEL_PREFIX /home/michaela/f110-2019-c/week4-wall-ws/devel)
  ...
  set(vesc_msgs_INSTALL_PREFIX /home/michaela/f110-2019-c/week4-wall-ws/install)
...
if(NOT "/home/michaela/f110-2019-c/week4-wall-ws/devel/include " STREQUAL " ")
  set(vesc_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/michaela/f110-2019-c/week4-wall-ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/michaela/f110-2019-c/week4-wall-ws/src/f110-skeletons-spring2019/system/vesc/vesc_msgs/${idir}'.  ${_report}")
    endif()
